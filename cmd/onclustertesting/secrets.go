...
func createLongLivedImagePushSecretForPool(ctx context.Context, cs *framework.ClientSet, poolName string) (string, error) {
	opts := utils.LongLivedSecretOpts{
...
func createLongLivedPullSecret(ctx context.Context, cs *framework.ClientSet, opts utils.LongLivedSecretOpts) error {
	...
	if err := utils.CreateLongLivedPullSecret(ctx, cs, opts); err != nil {
